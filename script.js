...
/**
 * Attach cursor-expand listeners to an element.
 * @param {HTMLElement} el
 */
function bigCursor(el) {
    el.addEventListener('mouseenter', () => {
        curEl.style.width = '20px';
        curEl.style.height = '20px';
...
// Attach to all static interactive elements
document.querySelectorAll('a, button').forEach(bigCursor);
